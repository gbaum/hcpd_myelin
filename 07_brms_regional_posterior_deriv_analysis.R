...
workspace_path <- "/ncf/hcp/data/analyses/myelin/Aug2021_brm_output/Glasser-MMP/regional/posterior_derivative_analysis/n628_Glasser_regional_myelin_brms_posterior_deriv_analysis.Rdata"
...
########################################
## Extract posterior sample summaries ##
########################################
